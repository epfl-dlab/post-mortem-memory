...
plot_all_model_fits <- function(medium) {
  models <- list("Biexponential"=biexp_fit(medium),
                 ...
                 "Log-normal-inspired\n(monotonic)"=lognorm_constrained_fit(medium),
...
When addressing this issue by constraining the log-normal-inspired model to be monotonically decreasing over the support range of the data (see plot labeled "Log-normal-inspired (monotonic)"), the AIC is considerably larger than the AIC of the biexpoential model both in the news and on Twitter.
